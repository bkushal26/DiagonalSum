...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sum.autotvin.dat"
	set constFileTvOut       "sum.autotvout.dat"
	set constFileHdlTvIn     "sum.autohdltvin.dat"
	set constFileHdlTvOut    "sum.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
