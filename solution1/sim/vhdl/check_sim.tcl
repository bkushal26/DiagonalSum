...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.sum.autotvin_mat_0.dat"
         "c.sum.autotvin_mat_1.dat"
         "c.sum.autotvin_mat_2.dat"
         "c.sum.autotvin_mat_3.dat"
         "c.sum.autotvin_mat_4.dat"
         "c.sum.autotvin_mat_5.dat"
         "c.sum.autotvin_mat_6.dat"
         "c.sum.autotvin_mat_7.dat"
         "c.sum.autotvin_mat_8.dat"
         "c.sum.autotvout_mat_0.dat"
         "c.sum.autotvout_mat_1.dat"
         "c.sum.autotvout_mat_2.dat"
         "c.sum.autotvout_mat_3.dat"
         "c.sum.autotvout_mat_4.dat"
         "c.sum.autotvout_mat_5.dat"
         "c.sum.autotvout_mat_6.dat"
         "c.sum.autotvout_mat_7.dat"
         "c.sum.autotvout_mat_8.dat"
         "c.sum.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.sum.autotvout_mat_0.dat"
         "rtl.sum.autotvout_mat_1.dat"
         "rtl.sum.autotvout_mat_2.dat"
         "rtl.sum.autotvout_mat_3.dat"
         "rtl.sum.autotvout_mat_4.dat"
         "rtl.sum.autotvout_mat_5.dat"
         "rtl.sum.autotvout_mat_6.dat"
         "rtl.sum.autotvout_mat_7.dat"
         "rtl.sum.autotvout_mat_8.dat"
         "rtl.sum.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
